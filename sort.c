...
int compr(void *a, void *b){
	return compare(*(int*) a, *(int*) b);
}

void qsort_help(int *numbers, unsigned count){
	qsort(numbers, count, sizeof(int), compr);
}

sorting_fn sorting_fns[] = {bubble_sort, insertion_sort, qsort_help, NULL};
